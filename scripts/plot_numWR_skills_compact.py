...
fig, axs = plt.subplots(
    ...
    layout="constrained", sharex='row', sharey=True, gridspec_kw={'wspace': 0, 'hspace': 0.7}
)
axs[0,0].text(0.45, 1.3, 'two-meter temperature', fontsize=9.5, transform=axs[0,0].transAxes)
axs[0,0].set_title('winter (DJF)', fontsize=8.5)
axs[0,1].set_title('summer (JJA)', fontsize=8.5)
axs[1,0].text(0.7, 1.3, 'precipitation', fontsize=9.5, transform=axs[1,0].transAxes)
axs[1,0].set_title('winter (DJF)', fontsize=8.5)
axs[1,1].set_title('summer (JJA)', fontsize=8.5)
axs[0,0].set_xlim(-1.5, 7.5)
axs[1,0].set_xlim(-1.5, 7.5)
[axs[i,j].set_ylim(-1, 1) for i in range(2) for j in range(2)]

# ----------------
# Plot temperature
# ----------------
# 7WR winter
plot_boxplot(axs[0,0], model_7wrT_winter_MAE.data.flatten(), [-.9,], wr7_color, '*')
plot_boxplot(axs[0,0], model_7wrT_winter_ACC.data.flatten(), [2.1,], wr7_color, '*')
plot_boxplot(axs[0,0], model_7wrT_winter_CE.data.flatten(), [5.1,], wr7_color, '*')

# 4WR winter
plot_boxplot(axs[0,0], model_4wrT_winter_MAE.data.flatten(), [-.3,], wr4_color, '*')
plot_boxplot(axs[0,0], model_4wrT_winter_ACC.data.flatten(), [2.7,], wr4_color, '*')
plot_boxplot(axs[0,0], model_4wrT_winter_CE.data.flatten(), [5.7,], wr4_color, '*')

# NAO winter
plot_boxplot(axs[0,0], model_NAOT_winter_MAE.data.flatten(), [0.3,], NAO_color, '*')
plot_boxplot(axs[0,0], model_NAOT_winter_ACC.data.flatten(), [3.3,], NAO_color, '*')
plot_boxplot(axs[0,0], model_NAOT_winter_CE.data.flatten(), [6.3,], NAO_color, '*')

# 0WR winter
plot_boxplot(axs[0,0], model_0wrT_winter_MAE.data.flatten(), [.9,], wr0_color, '*')
plot_boxplot(axs[0,0], model_0wrT_winter_ACC.data.flatten(), [3.9,], wr0_color, '*')
plot_boxplot(axs[0,0], model_0wrT_winter_CE.data.flatten(), [6.9,], wr0_color, '*')

# 7WR summer
plot_boxplot(axs[0,1], model_7wrT_summer_MAE.data.flatten(), [-0.9,], wr7_color, '*')
plot_boxplot(axs[0,1], model_7wrT_summer_ACC.data.flatten(), [2.1,], wr7_color, '*')
plot_boxplot(axs[0,1], model_7wrT_summer_CE.data.flatten(), [5.1,], wr7_color, '*')

# 4WR summer
plot_boxplot(axs[0,1], model_4wrT_summer_MAE.data.flatten(), [-.3,], wr4_color, '*')
plot_boxplot(axs[0,1], model_4wrT_summer_ACC.data.flatten(), [2.7,], wr4_color, '*')
plot_boxplot(axs[0,1], model_4wrT_summer_CE.data.flatten(), [5.7,], wr4_color, '*')

# NAO summer
plot_boxplot(axs[0,1], model_NAOT_summer_MAE.data.flatten(), [0.3,], NAO_color, '*')
plot_boxplot(axs[0,1], model_NAOT_summer_ACC.data.flatten(), [3.3,], NAO_color, '*')
plot_boxplot(axs[0,1], model_NAOT_summer_CE.data.flatten(), [6.3,], NAO_color, '*')

# 0WR summer
plot_boxplot(axs[0,1], model_0wrT_summer_MAE.data.flatten(), [0.9,], wr0_color, '*')
plot_boxplot(axs[0,1], model_0wrT_summer_ACC.data.flatten(), [3.9,], wr0_color, '*')
plot_boxplot(axs[0,1], model_0wrT_summer_CE.data.flatten(), [6.9,], wr0_color, '*')

# ------------------
# Plot precipitation
# ------------------
# 7WR winter
plot_boxplot(axs[1,0], model_7wrP_winter_MAE.data.flatten(), [-0.9,], wr7_color, '*')
plot_boxplot(axs[1,0], model_7wrP_winter_ACC.data.flatten(), [2.1,], wr7_color, '*')
plot_boxplot(axs[1,0], model_7wrP_winter_CE.data.flatten(), [5.1,], wr7_color, '*')

# 4WR winter
plot_boxplot(axs[1,0], model_4wrP_winter_MAE.data.flatten(), [-.3,], wr4_color, '*')
plot_boxplot(axs[1,0], model_4wrP_winter_ACC.data.flatten(), [2.7,], wr4_color, '*')
plot_boxplot(axs[1,0], model_4wrP_winter_CE.data.flatten(), [5.7,], wr4_color, '*')

# NAO winter
plot_boxplot(axs[1,0], model_NAOP_winter_MAE.data.flatten(), [0.3,], NAO_color, '*')
plot_boxplot(axs[1,0], model_NAOP_winter_ACC.data.flatten(), [3.3,], NAO_color, '*')
plot_boxplot(axs[1,0], model_NAOP_winter_CE.data.flatten(), [6.3,], NAO_color, '*')

# 0WR winter
plot_boxplot(axs[1,0], model_0wrP_winter_MAE.data.flatten(), [0.9,], wr0_color, '*')
plot_boxplot(axs[1,0], model_0wrP_winter_ACC.data.flatten(), [3.9,], wr0_color, '*')
plot_boxplot(axs[1,0], model_0wrP_winter_CE.data.flatten(), [6.9,], wr0_color, '*')

# 7WR summer
plot_boxplot(axs[1,1], model_7wrP_summer_MAE.data.flatten(), [-0.9,], wr7_color, '*')
plot_boxplot(axs[1,1], model_7wrP_summer_ACC.data.flatten(), [2.1,], wr7_color, '*')
plot_boxplot(axs[1,1], model_7wrP_summer_CE.data.flatten(), [5.1,], wr7_color, '*')

# 4WR summer
plot_boxplot(axs[1,1], model_4wrP_summer_MAE.data.flatten(), [-0.3,], wr4_color, '*')
plot_boxplot(axs[1,1], model_4wrP_summer_ACC.data.flatten(), [2.7,], wr4_color, '*')
plot_boxplot(axs[1,1], model_4wrP_summer_CE.data.flatten(), [5.7,], wr4_color, '*')

# NAO summer
plot_boxplot(axs[1,1], model_NAOP_summer_MAE.data.flatten(), [0.3,], NAO_color, '*')
plot_boxplot(axs[1,1], model_NAOP_summer_ACC.data.flatten(), [3.3,], NAO_color, '*')
plot_boxplot(axs[1,1], model_NAOP_summer_CE.data.flatten(), [6.3,], NAO_color, '*')

# 0WR summer
plot_boxplot(axs[1,1], model_0wrP_summer_MAE.data.flatten(), [0.9,], wr0_color, '*')
plot_boxplot(axs[1,1], model_0wrP_summer_ACC.data.flatten(), [3.9,], wr0_color, '*')
plot_boxplot(axs[1,1], model_0wrP_summer_CE.data.flatten(), [6.9,], wr0_color, '*')

# legend
legend_elements = [
    Patch(color=wr7_color, label='7 WR'),
    Patch(color=wr4_color, label='4 WR'),
    Patch(color=NAO_color, label='NAO'),
    Patch(color=wr0_color, label='No index'),
]
legend = fig.legend(handles=legend_elements, ncol=4, loc='upper left',  bbox_to_anchor=(0.4, 1.85), bbox_transform=axs[0,0].transAxes, columnspacing=0.5)
legend._legend_box.width = 120
xshift = [-24, -24, -22, -30]
...
axs[0,0].set_xticks([0, 3, 6])
axs[0,1].set_xticks([0, 3, 6])
axs[1,0].set_xticks([0, 3, 6])
axs[1,1].set_xticks([0, 3, 6])
axs[0,0].set_xticklabels(['MAE', 'ACC', 'CE'])
axs[0,1].set_xticklabels(['MAE', 'ACC', 'CE'])
axs[1,0].set_xticklabels(['MAE', 'ACC', 'CE'])
axs[1,1].set_xticklabels(['MAE', 'ACC', 'CE'])
[axs[i,j].tick_params(axis='x', which='both', top=False) for i in range(2) for j in range(2)]
[axs[i,j].tick_params(axis='x', which='both', bottom=False) for i in range(2) for j in range(2)]

[axs[i,j].axvspan(1.5, 4.5, color='gray', alpha=.1, lw=0) for i in range(2) for j in range(2)]


# save
plt.tight_layout()
plt.savefig(f'plots/numWR_skills_compact.pdf', bbox_inches='tight')

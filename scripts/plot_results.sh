...
ERA5_z500="${PWD}/${13}"       # path to the ERA5 z500 daily anomalies    #../data/daily_z500_noa_19400101-20241231_regrid.nc
ERA5_t2m="${PWD}/${14}"        # path to the ERA5 t2m  monthly anomalies  #../data/monthly_t2m_anom_europe_19400101-20241231_regrid.nc
ERA5_tp="${PWD}/${16}"         # path to the ERA5 z500 monthly anomalies  #../data/monthly_tp_anom_europe_19400101-20241231_merged.nc

...
ERA5_t2m_monthly="$data_dir/monthly_t2m_anom_europe_19400101-20241231_regrid.nc"  # path to the ERA5 monthly t2m anomalies
ERA5_tp_monthly="$data_dir/monthly_tp_anom_europe_19400101-20241231_regrid.nc"    # path to the ERA5 monthly tp anomalies
ERA5_7wr_monthly="$data_dir/monthly_z500_7wr_noa_19400101-20241201.nc"            # path to the ERA5 monthly 7 WR indices
